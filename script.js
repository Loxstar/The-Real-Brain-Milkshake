...
addActor();
/*
6. Now that you've added a "boxoffice" property, subtract "budget" from "property" and return the 
difference. This number is the amount lost by the studio in making the film. Return the loss.
*/
let film = {
    title : "Seven Samurai",
    director : "Akira Kurosawa",
